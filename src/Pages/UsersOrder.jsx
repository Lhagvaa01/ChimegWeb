...
const UsersOrder = () => {
  ...
  return (
    <div className="grid justify-center w-full p-4 mt-36 mb-10">
      <h2 className="text-2xl font-bold pb-4">Баталгаажсан Захиалгын түүх</h2>
      <div className="bg-white p-6 shadow-lg rounded-lg">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow flex flex-col items-center">
            ...
            <span className="text-sm text-gray-600">Хүргэгдсэн захиалга</span>
          </div>
        </div>
                  ...
                  <div className="flex flex-col lg:flex-row items-start lg:items-center">
                    <div className="grid">
                      ...
                      <p className="text-gray-900 text-sm">
                        {userAddress.find((addr) => addr.id === item.TCAddress)
                          ? userAddress.find(
